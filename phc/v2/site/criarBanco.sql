...
drop schema if exists obreiro cascade;
create schema if not exists obreiro;

drop schema if exists ordem cascade;
create schema if not exists ordem;




drop table if exists auditoria.tblEvento;
create table if not exists auditoria.tblEvento(
	id serial not null,
	evento varchar(30),
	primary key (id)
);

insert into auditoria.tblEvento (id, evento) values
(1, 'Consultar'),
(2, 'Inserir'),
(3, 'Modificar'),
(4, 'Excluir');

drop table if exists auditoria.tblObjeto;
create table if not exists auditoria.tblObjeto(
	id serial not null,
	objeto varchar(30),
	primary key (id)
);

insert into auditoria.tblObjeto (id, objeto) values
(1, 'Tabela'),
(2, 'Lista'),
(3, 'Relatorio PDF'),
(4, 'Tela de Cadastro');
...
drop table if exists auditoria.tblauditoria;
create table if not exists auditoria.tblauditoria(
	id serial not null,
	idEvento smallint,
	idObjeto int,
	idUsuario integer,
...
drop table if exists admin.tblPreferenciasNiveisMenus;
create table if not exists admin.tblPreferenciasNiveisMenus(
	id serial not null,
	nivel smallint not null,
	corNivel varchar(7) not null,
	corSelecao varchar(7) not null,
	icone varchar(255),
	primary key (id)
);

insert into admin.tblPreferenciasNiveisMenus (id, nivel, corNivel, corSelecao, icone) values
	(1, 1, '#', '#','\f035'),
	(2, 2, '#', '#', '\f035'),
	(3, 3, '#', '#', '\f035');


drop table if exists admin.tblPerfis;
create table if not exists admin.tblPerfis(
	id serial not null,
	perfil varchar(25),
	primary key (id)
);

insert into admin.tblPerfis (id, perfil) values
	(1, 'Desenvolvedor'),
	(2, 'Administrador'),
	(3, 'Usuario');


drop table if exists admin.tblMenus;
create table if not exists admin.tblMenus(
	id serial not null,
	nivel smallint[] not null,
	menu varchar(40) not null,
	idUL varchar(20),
	classeUL varchar(255),
	idLI varchar(20),
	classeLI varchar(255),
	toggle varchar(255),
	target varchar(255),
	href varchar(255),
	span varchar(35)[],	
...
insert into admin.tblMenus (nivel, menu, idUL, classeUL, idLI, classeLI, toggle, target, href, span, icone) values
	(array[1], 'A Obediencia', 'menu-content', 'menu-content collapse out', '', 'collapsed', 'collapse', '#obediencia', '#', array['arrow'], 'fa fa-institution fa-lg'),
	(array[1, 1], 'Sobre o G∴O∴M∴B∴', 'obediencia', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[2], 'O Rito', 'menu-content', 'menu-content collapse out', '', 'collapsed', 'collapse', '#rito', '#', array['arrow'], 'fa fa-fire fa-lg'),
	(array[2, 1], 'Sobre o Rito Emulation', 'rito', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-info-circle fa-lg'),
	(array[2, 2], 'O Ritual', 'rito', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-book fa-lg'),
	(array[2, 3], 'Lista de Abreviaturas Maçonicas', 'rito', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-key fa-lg'),
	(array[2, 4], 'Lista de Trabalhos do 1º grau', 'rito', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-file-text fa-lg'),
	(array[3], 'A Loja', 'menu-content', 'menu-content collapse out', '', 'collapsed', 'collapse', '#loja', '#', array['arrow'], 'fa fa-gavel fa-lg'),
	(array[3, 1], 'Sobre a PHC', 'loja', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-info-circle fa-lg'),
	(array[3, 2], 'Integrantes', 'loja', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning','fa fa-unlock-alt fa-lg'], ''),
	(array[3, 3], 'As Luzes', 'loja', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-sun-o fa-lg'),
	(array[3, 4], 'Agenda de Eventos', 'loja', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-calendar fa-lg'),
	(array[3, 5], 'Galeria de Fotos', 'loja', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[3, 6], 'Contato', 'loja', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[3, 7], 'Fale com o V∴M∴', 'loja', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4], 'As Comissoes', 'menu-content', 'menu-content collapse out', '', 'collapsed', 'collapse', '#comissoes', '#', array['arrow'], 'fa fa-users fa-lg'),
	(array[4, 1], 'A Comissao de Benemerencia', 'comissoes', 'sub-menu collapse', '', 'collapsed', 'collapse', '#benemerencia', '#', array['arrow'], 'fa fa-heart fa-lg'),
	(array[4, 1, 1], 'Sobre a Comissao', 'benemerencia', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-info-circle fa-lg'),
	(array[4, 1, 2], 'Campanhas', 'benemerencia', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4, 1, 3], 'Instituiçoes Apoiadas', 'benemerencia', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4, 1, 4], 'Galeria de Fotos', 'benemerencia', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4, 1, 5], 'Estatisticas', 'benemerencia', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4, 1, 6], 'Fale com a Comissao', 'benemerencia', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4, 2], 'A Comissao de Iniciacao', 'comissoes', 'sub-menu collapse', '', 'collapsed', 'collapse', '#iniciacao', '#', array['arrow'], 'fa fa-plus fa-lg'),
	(array[4, 2, 1], 'Sobre a Comissao', 'iniciacao', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-info-circle fa-lg'),
	(array[4, 2, 2], 'Regras de Sindicancia', 'iniciacao', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4, 2, 3], 'Galeria de Fotos', 'iniciacao', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4, 2, 4], 'Fale com a Comissao', 'iniciacao', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4, 3], 'A Comissao de Ritualistica', 'comissoes', 'sub-menu-n3 collapse', '', 'collapsed', 'collapse', '#ritualistica', '#', array['arrow'], 'fa fa-book fa-lg'),
	(array[4, 3, 1], 'Sobre a Comissao', 'ritualistica', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-info-circle fa-lg'),
	(array[4, 3, 2], 'Sobre a Ritualistica', 'ritualistica', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-info-circle fa-lg'),
	(array[4, 3, 3], 'Fale com a Comissao', 'ritualistica', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4, 4], 'A Comissao de Finanças', 'comissoes', 'sub-menu-n3 collapse', '', 'collapsed', 'collapse', '#financas', '#', array['arrow'], 'fa fa-money fa-lg'),
	(array[4, 4, 1], 'Sobre a Comissao', 'financas', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-info-circle fa-lg'),
	(array[4, 4, 2], 'Contabilidade da Loja', 'financas', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4, 4, 3], 'Prestaçao de Contas', 'financas', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[4, 4, 4], 'Fale com a Comissao', 'financas', 'sub-menu-n3 collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[5], 'O Obreiro', 'menu-content', 'menu-content collapse out', '', 'collapsed', 'collapse', '#obreiro', '#', array['arrow'], 'fa fa-user fa-lg'),
	(array[5, 1], 'Sobre os Obreiros', 'obreiro', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-info-circle fa-lg'),
	(array[5, 2], 'Cadastro de obreiros', 'obreiro', 'sub-menu collapse', 'cad-pessoa', '', '', '', '#', array['label label-info', 'fa fa-unlock-alt fa-lg'], 'fa fa-user-plus fa-lg'),
	(array[5, 3], 'Lista de Obreiros', 'obreiro', 'sub-menu collapse', 'lista-pessoas', '', '', '', '#', array['label label-info', 'fa fa-unlock-alt fa-lg'], 'fa fa-id-card-o fa-lg'),
	(array[5, 4], 'Consultar Pagamentos', 'obreiro', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[5, 5], 'Consultar Frequencia', 'obreiro', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[6], 'Os Documentos', 'menu-content', 'menu-content collapse out', '', 'collapsed', 'collapse', '#documentos', '#', array['arrow'], 'fa fa-folder-open fa-lg'),
	(array[6, 1], 'Sobre os Documentos', 'documentos', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-info-circle fa-lg'),
	(array[6, 2], 'Incluir Documentos', 'documentos', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[6, 3], 'Consultar Documentos', 'documentos', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], ''),
	(array[7], 'Perfil', 'menu-content', 'menu-content collapse out', '', 'collapsed', 'collapse', '#perfil', '#', array['arrow'], 'fa fa-user fa-lg'),
	(array[7, 1], 'Preferencias', 'perfil', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-wrench fa-lg'),
	(array[7, 2], 'Mensagens', 'perfil', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-comments-o fa-lg'),
	(array[7, 3], 'Minha frequencia', 'perfil', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-calendar-o fa-lg'),
	(array[7, 4], 'Meus Trabalhos', 'perfil', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-file-text-o fa-lg'),
	(array[7, 5], 'Meus Pagamentos', 'perfil', 'sub-menu collapse', '', '', '', '', '#', array['label label-warning', 'fa fa-unlock-alt fa-lg'], 'fa fa-money fa-lg'),
	(array[7, 6], 'Sair', 'perfil', 'sub-menu collapse', 'sair', '', '', '', 'sair.php?token=.dm5(session_id())', array['label label-info al-balao', 'fa fa-thumbs-up fa-lg'], 'fa fa-reply-all fa-lg');


drop table if exists auxiliar.tblTipoEndereco;
create table if not exists auxiliar.tblTipoEndereco(
	id serial not null,
	tipoEndereco varchar(15),
	primary key (id)
);

insert into auxiliar.tblTipoEndereco (id, tipoEndereco) values
	(1, 'Residencial'),
	(2, 'Trabalho');

drop table if exists auxiliar.tblTipoContato;
create table if not exists auxiliar.tblTipoContato(
	id serial not null,
	tipoContato varchar(20),
	primary key (id)
);

insert into auxiliar.tblTipoContato (id, tipoContato) values
	(1, 'Telefone Residencial'),
	(2, 'Telefone Comercial'),
	(3, 'E-mail Pessoal'),
	(4, 'E-mail Comercial');

drop table if exists auxiliar.tblNivelFormacao;
create table if not exists auxiliar.tblNivelFormacao(
	id serial not null,
	nivelFormacao varchar(30),
	primary key (id)
);

insert into auxiliar.tblnivelformacao(id, nivelFormacao) values
...
drop table if exists auxiliar.tblIdiomas;
create table if not exists auxiliar.tblIdiomas(
	id serial not null,
	idioma varchar(30),
	primary key (id)
);

insert into auxiliar.tblidiomas(id, idioma) values
	(1, 'Portugues'),
	(2, 'Ingles'),
	(3, 'Espanhol'),
	(4, 'Frances'),
...
drop table if exists auxiliar.tblTipoSanguineo;
create table if not exists auxiliar.tblTipoSanguineo(
	id serial not null,
	tipoSanguineo varchar(3),
	primary key (id)
);

insert into auxiliar.tbltiposanguineo(id, tipoSanguineo) values
	(1, 'A+'),
	(2, 'A-'),
	(3, 'B+'),
	(4, 'B-'),
...
drop table if exists auxiliar.tblPais cascade;
create table if not exists auxiliar.tblPais (
  id serial not null,
  pais character varying(60),
  paisSigla character varying(10),
  codTelefonia character varying(3),
  primary key (id)
);

insert into auxiliar.tblPais (id, pais, paisSigla, codTelefonia) values
	(1, 'Brasil', 'BR', '+55');

drop table if exists auxiliar.tblEstado cascade;
create table if not exists auxiliar.tblEstado (
  id serial not null,
  estado character varying(100),
  estadoSigla character varying(5),
  pais integer references auxiliar.tblPais(id),
  primary key (id)
);


insert into auxiliar.tblEstado (id, estado, estadoSigla, pais) values
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
drop table if exists auxiliar.tbl_Cidade cascade;
create table if not exists auxiliar.tblCidade (
  id serial NOT NULL,
  cidade character varying(120),
  estado integer references auxiliar.tblEstado(id),
  PRIMARY KEY (id)
);

insert into auxiliar.tblCidade(id, cidade, estado) values
(1, 'Afonso Cláudio', 8),
...
drop table if exists ordem.tblRitos;
create table if not exists ordem.tblRitos(
	id serial not null,
	rito varchar(80),
	primary key (id)
);

insert into ordem.tblRitos(id, rito) values
	(1, 'Emulation'),
	(2, 'York'),
	(3, 'R.E.A.A. - Rito Escoces Antigo e Aceito');


drop table if exists ordem.tblGrauMaconico;
create table if not exists ordem.tblGrauMaconico(
	id serial not null,
	idRito smallint references ordem.tblritos(id),
	grau varchar(4),
	primary key (id)
);

insert into ordem.tblGrauMaconico (id, idRito, grau) values
	(1, 1, 'A∴M∴'),
	(2, 1, 'C∴M∴'),
	(3, 1, 'M∴M∴'),
	(4, 1, '1'),
...
drop table if exists obreiro.tblPessoas;
create table if not exists obreiro.tblPessoas(
	id serial not null,
	nome varchar(80) not null,
	nomeChamado varchar(40),
	dtNascimento date,
	idTipoSanguineo smallint references auxiliar.tbltiposanguineo(id),
	planoSaude varchar(60),
	linkedin varchar(100),
	senha varchar(32),
	primary key (id)
);

insert into obreiro.tblPessoas (nome, nomeChamado, dtNascimento, idTipoSanguineo, senha) values
	('Hallysson Guimarães', 'Hallysson', '1978-01-07', 7, md5('teste'));


drop table if exists obreiro.tblObreiro;
create table if not exists obreiro.tblObreiro(
	id serial not null,
	idPessoa int references obreiro.tblpessoas(id),
	cim varchar(8) not null,
	dataCim date,
	idPerfil smallint references admin.tblPerfis(id),
	primary key (id)
);

insert into obreiro.tblObreiro (idPessoa, cim, dataCim, idPerfil) values
	(1, '809/15', '2015-09-23', 1);


drop table if exists obreiro.tblHistorioMaconico;
create table if not exists obreiro.tblHistoricoMaconico(
	id serial not null,
	idObreiro int references obreiro.tblobreiro(id),
	idGrauMaconico smallint references ordem.tblgraumaconico(id),
	idRito smallint references ordem.tblritos(id),
	dataInicio date,
	dataFim date,
	primary key (id)
...
drop table if exists obreiro.tblContato;
create table if not exists obreiro.tblContato(
	id serial not null,
	idPessoa int references obreiro.tblpessoas(id),
	idTipoContato int references auxiliar.tblTipoContato(id),
	contato varchar(80),
	nomeTerceiro varchar(80),
	primary key (id)
);

drop table if exists obreiro.tblEndereco;
create table if not exists obreiro.tblEndereco(
	id serial not null,
	idPessoa int references obreiro.tblpessoas(id),
	idTipoEndereco int references auxiliar.tblTipoEndereco(id),
	cep varchar(8),
	...
	cidade varchar(120),
	uf  varchar(2),
	idCidade int references auxiliar.tblcidade(id),
	idEstado smallint references auxiliar.tblestado(id),
	primary key (id)
);

drop table if exists obreiro.tblDadosSaude;
create table if not exists obreiro.tblDadosSaude(
	id serial not null,
	idPessoa int references obreiro.tblpessoas(id),
...
drop table if exists obreiro.tblDadosFormacao;
create table if not exists obreiro.tblDadosFormacao(
	id serial not null,
	idPessoa int references obreiro.tblpessoas(id),
	instituicao varchar(150),
	idNivelFormacao smallint references auxiliar.tblnivelformacao(id),
	primary key (id)
);

drop table if exists obreiro.tblDadosIdiomas;
create table if not exists obreiro.tblDadosIdiomas(
	id serial not null,
	idPessoa int references obreiro.tblpessoas(id),
	idIdioma smallint references auxiliar.tblidiomas(id),
	nivelIdioma smallint,
	primary key (id)
);

drop table if exists obreiro.tblDadosProfissionais;
create table if not exists obreiro.tblDadosProfissionais(
	id serial not null,
	idPessoa int references obreiro.tblpessoas(id),
	empresa varchar(150),
	primary key (id)
...
drop table if exists obreiro.tblHistoricoEmpresas;
create table if not exists obreiro.tblHistoricoEmpresas(
	id serial not null,
	idDadosProfissionais smallint references obreiro.tbldadosprofissionais(id),
	cargo varchar(150),
	dataInicio date,
	dataFim date,
	primary key (id)
